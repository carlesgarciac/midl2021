...
def select_annotated_frames_mms(data_folder, out_folder, add_zeros=False, mode='mnms', df_path="/home/carlesgc/Projects/nnUnetMIDL/mms/201014_M&Ms_Dataset_Information_-_opendataset.csv"):
    ...
    for idx in table.index:
        ...
        auxiliar = str(filename_ed).split('/')[-1]
        # print(auxiliar)
        auxiliar1 = auxiliar.split('_')[0]
        auxiliar2 = auxiliar.split('_')[1]
        auxiliar = str(auxiliar1)+str('_')+str(auxiliar2)+str('.nii.gz')
        # print(auxiliar)
        if auxiliar in os.listdir('/home/carlesgc/Projects/nnUnetMIDL/mms/temp_split_raw_test'):
...
if __name__ == "__main__":
    ...
    train_dir = "/home/carlesgc/Projects/nnUnetMIDL/nnUNet_raw/nnUNet_raw_data_base/nnUNet_raw_data/{}/imagesTr".format(task_name)
    test_dir = "/home/carlesgc/Projects/nnUnetMIDL/nnUNet_raw/nnUNet_raw_data_base/nnUNet_raw_data/{}/imagesTs".format(task_name)

    # out_dir='/media/full/tera2/output_nnUNet/preprocessed_data/Task114_heart_mnms'
    # out_dir='/home/carlesgc/Projects/nnUnetMIDL/tmp'
    out_dir = '/home/carlesgc/Projects/nnUnetMIDL/nnUNet_raw/nnUNet_raw_data_base/nnUNet_raw_data/Task114_heart_MNMs'
    ...
    data_root_test = '/home/carlesgc/Projects/nnUnetMIDL/mms/Testing'
    files_raw_test, files_gt_test = get_mnms_data(data_root=data_root_test)
    split_path_raw_test ='/home/carlesgc/Projects/nnUnetMIDL/mms/temp_split_raw_test'
    split_path_gt_test ='/home/carlesgc/Projects/nnUnetMIDL/mms/temp_split_gt_test'
    maybe_mkdir_p(split_path_raw_test)
    maybe_mkdir_p(split_path_gt_test)

    split_4d_for_all_pat(files_raw_test, split_path_raw_test)
    print('files done')
    split_4d_for_all_pat(files_gt_test, split_path_gt_test)
    print('labels done')
    # out_dir = '/home/carlesgc/Projects/nnUnetMIDL/nnUNet_raw/nnUNet_raw_data_base/nnUNet_raw_data/{}/'.format(task_name)

    maybe_mkdir_p(join(out_dir, "imagesTr"))
    maybe_mkdir_p(join(out_dir, "imagesTs"))
    maybe_mkdir_p(join(out_dir, "labelsTr"))
    maybe_mkdir_p(join(out_dir, "labelsTs"))

    imagesTs_path = os.path.join(out_dir, "imagesTs")
    labelsTs_path = os.path.join(out_dir, "labelsTs")

    select_annotated_frames_mms(split_path_raw_test, imagesTs_path, add_zeros=True)
    select_annotated_frames_mms(split_path_gt_test, labelsTs_path, add_zeros=False)


    labelsTs = subfiles(labelsTs_path)
    ...
    # save_pickle(splits, "/home/carlesgc/Projects/nnUnetMIDL/nnUNet_raw/nnUNet_raw_data_base/nnUNet_raw_data/Task027_ACDC/splits_final.pkl")


    # split_file_path = '/home/carlesgc/Projects/nnUnetMIDL/output_nnUNet/preprocessed_data/{}/'.format(task_name)
